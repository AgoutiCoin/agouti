...
In order to support loading of multiple wallets in agoutiold-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is agoutiold.cpp.
...
Changes to agoutiold.cpp
----------------------
agoutiold.cpp is the entry point into agoutiold-qt, and as such, will require some minor modifications to provide hooks for
