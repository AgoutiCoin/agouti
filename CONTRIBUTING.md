Contributing to Agoutiold Core
============================

The Agoutiold Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Agoutiold Core project, and is not to be
confused with overall Agoutiold Network Protocol consensus changes.

Whether a pull request is merged into Agoutiold Core rests with the project merge
...
Patches that change Agoutiold consensus rules are considerably more involved than
...
Where a patch set proposes to change the Agoutiold consensus, it must have been
...
The project leader is the release manager for each Agoutiold Core release.
