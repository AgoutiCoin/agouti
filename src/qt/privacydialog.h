...
public:
    ...
    void setZAgoutioldControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzAGU_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzAGU_clicked();
    void on_pushButtonZAgoutioldControl_clicked();
