...
/** Utility functions used by the Agoutiold Qt UI.
 */
namespace GUIUtil
{
...
// Render Agoutiold addresses in monospace font
...
// Parse "agoutiold:" URI into recipient object, return true on successful parsing
