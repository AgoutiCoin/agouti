...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Agoutiold Core agoutiold-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  agoutiold-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded agoutiold transaction") + "\n" +
                               "  agoutiold-tx [options] -create [commands]   " + _("Create hex-encoded agoutiold transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded agoutiold transaction
