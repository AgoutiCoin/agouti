...
#define MASTERNODE_MIN_CONFIRMATIONS_V1 15
#define MASTERNODE_MIN_CONFIRMATIONS_V2 6
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 AGU, signature to prove
